  ...
  <el-container style="min-height: 100vh">
    <el-aside :width="isCollapse ? '64px' : '230px'" class="layout-aside">
      ...
      <el-menu :default-active="route.path" :collapse="isCollapse" router
        ...
        <el-menu-item index="/student/dashboard"><el-icon><HomeFilled /></el-icon><span slot="title">首页</span></el-menu-item>
        <el-menu-item index="/student/schedule"><el-icon><Timer /></el-icon><span slot="title">班级课表</span></el-menu-item>
        <el-menu-item index="/student/exams"><el-icon><Calendar /></el-icon><span slot="title">考试安排</span></el-menu-item>
        <el-menu-item index="/student/courses"><el-icon><Reading /></el-icon><span slot="title">课程查询</span></el-menu-item>
        <el-menu-item index="/student/notices"><el-icon><Bell /></el-icon><span slot="title">公告</span></el-menu-item>
        <div class="menu-divider"></div>
        <el-menu-item index="/student/profile"><el-icon><User /></el-icon><span slot="title">个人设置</span></el-menu-item>
      </el-menu>
    </el-aside>
    <el-container>
      <el-header class="layout-header">
        <div class="header-left">
          ...
          <span class="header-title">{{ route.meta?.title || '学生端' }}</span>
        </div>
        <div class="header-right">
          <el-dropdown trigger="click" @command="handleCommand">
            <span class="user-dropdown">
              <span class="header-user">{{ userInfo?.realName || userInfo?.username }}</span>
              <span class="header-role-tag">学生</span>
