/*
 ...
 Source Schema         : newemscss

 Target Server Type    : MySQL
 Target Server Version : 80041 (8.0.41)
 File Encoding         : 65001

 Date: 24/05/2026 21:39:49
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '审核记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of approval_record
-- ----------------------------
INSERT INTO `approval_record` VALUES (1, 1, 1, NULL, 'APPROVE', '同意分配', '2025-06-10 09:00:00');
INSERT INTO `approval_record` VALUES (2, 2, 1, NULL, 'APPROVE', '同意分配', '2025-06-10 09:30:00');
INSERT INTO `approval_record` VALUES (3, 3, 1, NULL, 'APPROVE', '同意分配', '2025-06-10 10:00:00');
INSERT INTO `approval_record` VALUES (4, 4, 1, NULL, 'APPROVE', '同意分配', '2025-06-11 09:00:00');
INSERT INTO `approval_record` VALUES (5, 5, 1, NULL, 'APPROVE', '同意分配', '2025-06-11 09:30:00');
INSERT INTO `approval_record` VALUES (6, 6, 1, NULL, 'APPROVE', '同意分配', '2025-06-11 10:00:00');
INSERT INTO `approval_record` VALUES (7, 7, 1, NULL, 'APPROVE', '同意', '2025-06-12 09:00:00');
INSERT INTO `approval_record` VALUES (8, 8, 1, NULL, 'APPROVE', '同意', '2025-06-12 09:30:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考试安排表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of exam_plan
-- ----------------------------
INSERT INTO `exam_plan` VALUES (1, '2025-2026-1', 1, 1, '2026-01-05', '08:00:00', '10:00:00', '计算中心A101', 4, 1, '2026-05-24 16:47:36');
INSERT INTO `exam_plan` VALUES (2, '2025-2026-1', 2, 1, '2026-01-08', '14:00:00', '16:00:00', '教学楼201', 5, 1, '2026-05-24 16:47:36');
INSERT INTO `exam_plan` VALUES (3, '2025-2026-1', 3, 3, '2026-01-10', '08:00:00', '10:00:00', '教学楼202', 5, 1, '2026-05-24 16:47:36');
INSERT INTO `exam_plan` VALUES (4, '2025-2026-1', 5, 3, '2026-01-12', '14:00:00', '16:00:00', '教学楼203', 7, 1, '2026-05-24 16:47:36');
INSERT INTO `exam_plan` VALUES (5, '2025-2026-1', 11, 9, '2026-01-06', '08:00:00', '10:00:00', '外语楼301', 13, 1, '2026-05-24 16:47:36');
INSERT INTO `exam_plan` VALUES (6, '2025-2026-1', 12, 10, '2026-01-07', '10:30:00', '12:00:00', '外语楼302', 14, 1, '2026-05-24 16:47:36');
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (1, '2025-2026-1学期教学计划开始申报', '各位老师：2025-2026-1学期教学计划现已开始申报，请各学院在6月30日前完成申报工作。', 'SYSTEM', 'ALL', 1, '2025-06-01 08:00:00', '2025-06-01 08:00:00');
INSERT INTO `notice` VALUES (2, '关于开展期中教学检查的通知', '学校将于第10周开展期中教学检查，请各位教师做好准备。', 'SYSTEM', 'TEACHER', 1, '2025-10-15 08:00:00', '2025-10-15 08:00:00');
INSERT INTO `notice` VALUES (3, '计算机学院教研活动安排', '本周三下午2:30在计算中心会议室开展教研活动，请全体教师参加。', 'COLLEGE', 'TEACHER', 2, '2025-09-20 09:00:00', '2025-09-20 09:00:00');
INSERT INTO `notice` VALUES (4, '商学院期末考试安排通知', '请各教研室主任于12月20日前提交期末考试命题。', 'COLLEGE', 'TEACHER', 4, '2025-12-01 10:00:00', '2025-12-01 10:00:00');
INSERT INTO `notice` VALUES (5, '关于寒假实验室安全工作的通知', '各实验室请在放假前进行安全检查，确保水电门窗关闭。', 'SYSTEM', 'ADMIN', 1, '2026-01-10 16:00:00', '2026-01-10 16:00:00');
INSERT INTO `notice` VALUES (6, '英语四六级考前辅导通知', '外国语学院将于6月10日举办英语四六级考前辅导讲座，欢迎同学们参加。', 'COLLEGE', 'STUDENT', 14, '2025-06-05 09:00:00', '2025-06-05 09:00:00');

-- ----------------------------
-- Table structure for room_plan
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教室安排表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of room_plan
-- ----------------------------
INSERT INTO `room_plan` VALUES (1, '2025-2026-1', '计算中心A101', 60, 1, 1, 1, 1, 1, '2026-05-24 16:47:36');
INSERT INTO `room_plan` VALUES (2, '2025-2026-1', '计算中心A101', 60, 1, 2, 1, 1, 1, '2026-05-24 16:47:36');
INSERT INTO `room_plan` VALUES (3, '2025-2026-1', '教学楼201', 80, 2, 3, 2, 1, 1, '2026-05-24 16:47:36');
INSERT INTO `room_plan` VALUES (4, '2025-2026-1', '教学楼201', 80, 2, 4, 2, 1, 1, '2026-05-24 16:47:36');
INSERT INTO `room_plan` VALUES (5, '2025-2026-1', '教学楼202', 80, 1, 3, 3, 3, 1, '2026-05-24 16:47:36');
INSERT INTO `room_plan` VALUES (6, '2025-2026-1', '教学楼202', 80, 1, 4, 3, 3, 1, '2026-05-24 16:47:36');
INSERT INTO `room_plan` VALUES (7, '2025-2026-1', '外语楼301', 50, 1, 1, 11, 9, 1, '2026-05-24 16:47:36');
INSERT INTO `room_plan` VALUES (8, '2025-2026-1', '外语楼301', 50, 1, 2, 11, 9, 1, '2026-05-24 16:47:36');
...
CREATE TABLE `schedule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课表表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of schedule
-- ----------------------------
INSERT INTO `schedule` VALUES (1, '2025-2026-1', 1, 1, 4, 1);
INSERT INTO `schedule` VALUES (2, '2025-2026-1', 1, 1, 4, 2);
INSERT INTO `schedule` VALUES (3, '2025-2026-1', 1, 1, 4, 11);
INSERT INTO `schedule` VALUES (4, '2025-2026-1', 1, 1, 4, 12);
INSERT INTO `schedule` VALUES (5, '2025-2026-1', 1, 2, 5, 8);
INSERT INTO `schedule` VALUES (6, '2025-2026-1', 1, 2, 5, 9);
INSERT INTO `schedule` VALUES (7, '2025-2026-1', 1, 2, 5, 18);
INSERT INTO `schedule` VALUES (8, '2025-2026-1', 3, 3, 5, 3);
INSERT INTO `schedule` VALUES (9, '2025-2026-1', 3, 3, 5, 4);
INSERT INTO `schedule` VALUES (10, '2025-2026-1', 3, 3, 5, 13);
INSERT INTO `schedule` VALUES (11, '2025-2026-1', 3, 5, 7, 6);
INSERT INTO `schedule` VALUES (12, '2025-2026-1', 3, 5, 7, 7);
INSERT INTO `schedule` VALUES (13, '2025-2026-1', 3, 5, 7, 16);
INSERT INTO `schedule` VALUES (14, '2025-2026-1', 2, 4, 8, 15);
INSERT INTO `schedule` VALUES (15, '2025-2026-1', 2, 4, 8, 21);
INSERT INTO `schedule` VALUES (16, '2025-2026-1', 2, 4, 8, 22);
INSERT INTO `schedule` VALUES (17, '2025-2026-1', 2, 6, 10, 19);
INSERT INTO `schedule` VALUES (18, '2025-2026-1', 2, 6, 10, 20);
INSERT INTO `schedule` VALUES (19, '2025-2026-1', 2, 6, 10, 23);
INSERT INTO `schedule` VALUES (20, '2025-2026-1', 9, 11, 13, 1);
INSERT INTO `schedule` VALUES (21, '2025-2026-1', 9, 11, 13, 2);
INSERT INTO `schedule` VALUES (22, '2025-2026-1', 9, 11, 13, 11);
INSERT INTO `schedule` VALUES (23, '2025-2026-1', 9, 11, 13, 12);
INSERT INTO `schedule` VALUES (24, '2025-2026-1', 10, 12, 14, 5);
INSERT INTO `schedule` VALUES (25, '2025-2026-1', 10, 12, 14, 14);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '系统管理员', '13800000000', 'admin@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (2, 'xy001', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '张明', '13800000001', 'zhangming@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (3, 'xy002', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '李丽', '13800000002', 'lili@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (4, 'xy003', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '王芳', '13800000003', 'wangfang@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (5, 'js001', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '王强', '13800000004', 'wangqiang@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (6, 'js002', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '赵芳', '13800000005', 'zhaofang@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (7, 'js003', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '刘伟', '13800000006', 'liuwei@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (8, 'js004', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '陈雪', '13800000007', 'chenxue@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (9, 'js005', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '吴磊', '13800000008', 'wulei@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (10, 'js006', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '周敏', '13800000009', 'zhoumin@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (11, 'js007', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '徐亮', '13800000010', 'xuliang@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (12, 'js008', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '李华', '13800000011', 'lihua@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (13, 'js009', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '王丽', '13800000012', 'wangli@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (14, 'js010', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '陈静', '13800000013', 'chenjing@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (15, 'js011', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '杨光', '13800000014', 'yangguang@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (16, 'js012', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '马超', '13800000015', 'machao@xtu.edu.cn', 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (17, 'S001', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '张三', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (18, 'S002', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '李四', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (19, 'S003', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '王五', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (20, 'S004', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '赵六', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (21, 'S005', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '孙七', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (22, 'S006', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '周八', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (23, 'S007', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '吴九', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (24, 'S008', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '郑十', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (25, 'S009', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '钱十一', NULL, NULL, 1, '2026-05-24 16:47:36');
INSERT INTO `sys_user` VALUES (26, 'S010', '$2a$10$xUq4REdF/1RYfmZdQvNZ5OprQ8o/mrFFyhc1Qa1Cf/3HxBBLR9Qje', '冯十二', NULL, NULL, 1, '2026-05-24 16:47:36');
...
INSERT INTO `sys_user_role` VALUES (21, 5);
INSERT INTO `sys_user_role` VALUES (22, 5);
INSERT INTO `sys_user_role` VALUES (23, 5);
INSERT INTO `sys_user_role` VALUES (24, 5);
INSERT INTO `sys_user_role` VALUES (25, 5);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '任务池表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of task_pool
-- ----------------------------
INSERT INTO `task_pool` VALUES (1, '2025-2026-1', 7, 4, 32, 2, 2, 0, NULL, '2025-06-01 08:00:00');
INSERT INTO `task_pool` VALUES (2, '2025-2026-1', 7, 5, 32, 2, 2, 0, NULL, '2025-06-01 08:00:00');
INSERT INTO `task_pool` VALUES (3, '2025-2026-1', 1, 4, 64, 4, 2, 0, NULL, '2025-06-01 08:00:00');
INSERT INTO `task_pool` VALUES (4, '2025-2026-1', 3, 5, 48, 3, 2, 0, NULL, '2025-06-01 08:00:00');
INSERT INTO `task_pool` VALUES (5, '2025-2026-1', 10, 7, 48, 3, 3, 0, NULL, '2025-06-01 08:00:00');
INSERT INTO `task_pool` VALUES (6, '2025-2026-1', 9, 8, 32, 2, 2, 0, NULL, '2025-06-01 08:00:00');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (1, 2, 'XY001', '教授', 4, 1, 1, 14, 1);
INSERT INTO `teacher` VALUES (2, 3, 'XY002', '副教授', 3, 1, 0, 12, 1);
INSERT INTO `teacher` VALUES (3, 4, 'XY003', '副教授', 3, 2, 0, 12, 1);
INSERT INTO `teacher` VALUES (4, 5, 'JS001', '教授', 4, 1, 1, 12, 1);
INSERT INTO `teacher` VALUES (5, 6, 'JS002', '副教授', 3, 1, 0, 12, 1);
INSERT INTO `teacher` VALUES (6, 7, 'JS003', '讲师', 2, 1, 0, 10, 1);
INSERT INTO `teacher` VALUES (7, 8, 'JS004', '讲师', 2, 1, 0, 10, 1);
INSERT INTO `teacher` VALUES (8, 9, 'JS005', '副教授', 3, 1, 1, 12, 1);
INSERT INTO `teacher` VALUES (9, 10, 'JS006', '助教', 1, 1, 0, 8, 1);
INSERT INTO `teacher` VALUES (10, 11, 'JS007', '讲师', 2, 1, 0, 10, 1);
INSERT INTO `teacher` VALUES (11, 12, 'JS008', '副教授', 3, 2, 0, 12, 1);
INSERT INTO `teacher` VALUES (12, 13, 'JS009', '讲师', 2, 2, 0, 10, 1);
INSERT INTO `teacher` VALUES (13, 14, 'JS010', '教授', 4, 3, 0, 12, 1);
INSERT INTO `teacher` VALUES (14, 15, 'JS011', '副教授', 3, 3, 1, 12, 1);
INSERT INTO `teacher` VALUES (15, 16, 'JS012', '助教', 1, 2, 0, 8, 1);

-- ----------------------------
-- Table structure for teaching_accident
-- ----------------------------
...
-- ----------------------------
-- Table structure for teaching_application
-- ----------------------------
...
CREATE TABLE `teaching_application`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教师授课申请表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of teaching_application
-- ----------------------------
INSERT INTO `teaching_application` VALUES (1, 4, 1, 1, NULL, 2, '2025-06-01 09:00:00');
INSERT INTO `teaching_application` VALUES (2, 5, 2, 1, NULL, 2, '2025-06-01 09:30:00');
INSERT INTO `teaching_application` VALUES (3, 5, 3, 2, NULL, 2, '2025-06-01 09:30:00');
INSERT INTO `teaching_application` VALUES (4, 7, 4, 1, NULL, 2, '2025-06-02 10:00:00');
INSERT INTO `teaching_application` VALUES (5, 8, 5, 1, NULL, 2, '2025-06-02 10:30:00');
INSERT INTO `teaching_application` VALUES (6, 10, 6, 1, NULL, 2, '2025-06-03 09:00:00');
INSERT INTO `teaching_application` VALUES (7, 13, 14, 1, NULL, 2, '2025-06-03 10:00:00');
INSERT INTO `teaching_application` VALUES (8, 14, 15, 1, NULL, 2, '2025-06-03 10:30:00');
INSERT INTO `teaching_application` VALUES (9, 9, 11, 1, NULL, 0, '2025-06-05 09:00:00');
INSERT INTO `teaching_application` VALUES (10, 6, 4, 1, NULL, 0, '2025-06-05 10:00:00');
INSERT INTO `teaching_application` VALUES (11, 10, 7, 1, NULL, 4, '2025-06-06 09:00:00');
INSERT INTO `teaching_application` VALUES (12, 11, 11, 1, NULL, 0, '2025-06-07 10:00:00');
INSERT INTO `teaching_application` VALUES (13, 5, 8, 1, '自动创建测试数据', 4, '2026-05-24 17:37:42');
...
-- ----------------------------
INSERT INTO `teaching_plan` VALUES (1, '2025-2026-1', 1, 1, 1, 64, 4, 5, 1);
INSERT INTO `teaching_plan` VALUES (2, '2025-2026-1', 1, 2, 1, 48, 3, 5, 1);
INSERT INTO `teaching_plan` VALUES (3, '2025-2026-1', 1, 3, 3, 48, 3, 5, 1);
INSERT INTO `teaching_plan` VALUES (4, '2025-2026-1', 1, 5, 3, 48, 3, 5, 1);
INSERT INTO `teaching_plan` VALUES (5, '2025-2026-1', 1, 4, 2, 48, 3, 5, 1);
INSERT INTO `teaching_plan` VALUES (6, '2025-2026-1', 1, 6, 2, 48, 3, 5, 1);
INSERT INTO `teaching_plan` VALUES (7, '2025-2026-1', 1, 7, 4, 32, 2, 5, 1);
INSERT INTO `teaching_plan` VALUES (8, '2025-2026-1', 1, 7, 5, 32, 2, 5, 1);
INSERT INTO `teaching_plan` VALUES (9, '2025-2026-1', 1, 1, 4, 64, 4, 2, 1);
INSERT INTO `teaching_plan` VALUES (10, '2025-2026-1', 1, 3, 5, 48, 3, 1, 1);
INSERT INTO `teaching_plan` VALUES (11, '2025-2026-1', 2, 8, 6, 48, 3, 3, 1);
INSERT INTO `teaching_plan` VALUES (12, '2025-2026-1', 2, 10, 7, 48, 3, 2, 1);
INSERT INTO `teaching_plan` VALUES (13, '2025-2026-1', 2, 9, 8, 32, 2, 1, 1);
INSERT INTO `teaching_plan` VALUES (14, '2025-2026-1', 3, 11, 9, 64, 4, 5, 1);
INSERT INTO `teaching_plan` VALUES (15, '2025-2026-1', 3, 12, 10, 32, 2, 5, 1);

-- ----------------------------
-- Table structure for teaching_rule
-- ----------------------------
...
CREATE TABLE `teaching_task`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教学任务表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of teaching_task
-- ----------------------------
INSERT INTO `teaching_task` VALUES (1, 4, 1, 1, '2025-2026-1', '主讲', 64, 4, 1);
INSERT INTO `teaching_task` VALUES (2, 5, 2, 1, '2025-2026-1', '主讲', 48, 3, 1);
INSERT INTO `teaching_task` VALUES (3, 5, 3, 3, '2025-2026-1', '主讲', 48, 3, 1);
INSERT INTO `teaching_task` VALUES (4, 7, 5, 3, '2025-2026-1', '主讲', 48, 3, 1);
INSERT INTO `teaching_task` VALUES (5, 8, 4, 2, '2025-2026-1', '主讲', 48, 3, 1);
INSERT INTO `teaching_task` VALUES (6, 10, 6, 2, '2025-2026-1', '主讲', 48, 3, 1);
INSERT INTO `teaching_task` VALUES (7, 13, 11, 9, '2025-2026-1', '主讲', 64, 4, 1);
INSERT INTO `teaching_task` VALUES (8, 14, 12, 10, '2025-2026-1', '主讲', 32, 2, 1);
INSERT INTO `teaching_task` VALUES (9, 5, 7, 5, '2025-2026-2', '主讲', 32, 2, 2);
INSERT INTO `teaching_task` VALUES (10, 10, 7, 4, '2025-2026-2', '主讲', 32, 2, 2);
